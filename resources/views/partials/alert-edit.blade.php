...
<div class="alertEdit bg-[#00000089] w-full h-screen fixed top-0 right-0 bottom-0 left-0 z-20 hidden justify-center items-center">
    <form action="" method="POST" autocomplete="off" class="formEditPost bg-gray-primary w-[450px] h-[550px] p-7 rounded-[10px] overflow-auto">
        ...
        <div class="flex flex-col my-5">
            ...
            <input type="url" required name="github" id="githubEdit" minlength="5" maxlength="500" class="w-full bg-zinc-600 py-2 px-3 text-sm rounded-[5px] focus:outline-none focus:shadow-none">
            {{-- error --}}
            @error('github')
                <p class="text-red-500 text-[12px] mt-1 ml-2">{{ $message }}</p>
            @enderror
        ...
        <div class="flex flex-col my-5">
            ...
            <input type="text" required name="author" id="authorEdit" minlength="3" maxlength="50" class="w-full bg-zinc-600 py-2 px-3 text-sm rounded-[5px] focus:outline-none focus:shadow-none">
            {{-- error --}}
            @error('author')
                <p class="text-red-500 text-[12px] mt-1 ml-2">{{ $message }}</p>
            @enderror
        ...
        <div class="flex flex-col my-5">
            ...
            <input type="text" required name="title" minlength="5" maxlength="254" id="titleEdit" class="w-full bg-zinc-600 py-2 px-3 text-sm rounded-[5px] focus:outline-none focus:shadow-none">
            {{-- error --}}
            @error('title')
                <p class="text-red-500 text-[12px] mt-1 ml-2">{{ $message }}</p>
            @enderror
        ...
        <div class="flex flex-col my-5">
            ...
            <input type="url" required name="slug" minlength="5" maxlength="254" id="slugEdit" class="w-full bg-zinc-600 py-2 px-3 text-sm rounded-[5px] focus:outline-none focus:shadow-none">
            {{-- error --}}
            @error('slug')
                <p class="text-red-500 text-[12px] mt-1 ml-2">{{ $message }}</p>
            @enderror
        ...
        <div class="flex flex-col my-5">
            ...
            <textarea name="excerpt" required minlength="5" maxlength="100000" id="excerptEdit" class="w-full h-40 bg-zinc-600 py-2 px-3 text-sm rounded-[5px] focus:outline-none focus:shadow-none"></textarea>
            {{-- error --}}
            @error('excerpt')
                <p class="text-red-500 text-[12px] mt-1 ml-2">{{ $message }}</p>
            @enderror
